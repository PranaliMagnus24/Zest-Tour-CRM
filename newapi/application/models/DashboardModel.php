...
class DashboardModel extends CI_model
{
    public function get_Dashboard_data()
    {
        ...
        $this->db->from('(SELECT reminderby,customer_id, MAX(time) AS time,reminder FROM reminder GROUP BY customer_id ORDER BY time DESC) as customer_id,enquiry as e,customer as c');  
        ...
        $this->db->where("(e.status!='DropOut' and e.status!='DropOut')");
        $this->db->where($where);  
