...
if ($req == 1) 
{
    ...
    foreach($new_array as $key=>$val)
    {
        ...
        ?>
        <div class="col-12 p-0 pull-left border-top b-l-r Flex" ondblclick="redirect(<?php echo $value['customer_id']?>, 'dashboard')" style="background-color: #ebeefe;display: flex;">
