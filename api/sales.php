...
if ($req == 1) 
{
    $i=1;
    $deg=array();
    $sql=mysqli_query($connect,"select * from sales_contact where candidate_id='$id' ORDER BY id ASC");
        ...
        while($rs=mysqli_fetch_assoc($sql))
        {
            ...
            <div class="col-12 pull-left text-center p-0 tab-color position-relative flex-info">
                ...
                <div class="pull-left border_table  border_top col-2">
                    ...
                    <span class="glyphicon glyphicon-trash col-6 p-0 pull-left" data-bs-target="#delete_data" data-bs-toggle="modal" onclick="set_delete_id('<?php echo $rs['id']?>','sales','#delete_data','get_sales')" style="line-height: 18px">Delete</span>            
                </div>
            </div>
