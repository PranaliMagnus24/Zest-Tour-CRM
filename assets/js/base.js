// baseurl = 'https://zesttourcrm.in/api/';
// baseurl1 = 'https://zesttourcrm.in/';
// newbaseurl = 'https://zesttourcrm.in/newapi/index.php/';
baseurl = 'http://localhost/zest-tour-crm/api/';
baseurl1 = 'http://localhost/zest-tour-crm/';
newbaseurl = 'http://localhost/zest-tour-crm/newapi/index.php/';
...
function get_staff_list() 
{
  ...
  $.ajax({
      ...
      success: function (data) 
      {
        ...
        if (document.getElementById('staff_dropdown')) {
...
$('#switch').click(function(){
    ...
    {
        window.location.href='https://travelreport.zesttourcrm.in/'
    }
})
